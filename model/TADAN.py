...
class TADAN(nn.Module):
    def __init__(self, time_steps, beta_start, beta_end, window_size, model_dim, ff_dim, atten_dim, feature_num,
                 time_num, block_num, head_num, dropout, device, d, t, eta=0.5 , teacher_model_path = None):
        super(TADAN, self).__init__()
        ...
        if teacher_model_path:
            self.teacher = torch.load(teacher_model_path)
